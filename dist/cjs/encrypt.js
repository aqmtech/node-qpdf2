...
var _spawn = _interopRequireDefault(require("./spawn.js"));
...
var encrypt = exports.encrypt = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(userPayload) {
    var payload, callArguments, _i, _Object$entries, _Object$entries$_i, restriction, value;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          // Set Defaults
          payload = _objectSpread(_objectSpread({}, EncryptDefaults), userPayload); // Check if the file exists
          if (payload.input) {
            _context.next = 3;
            break;
          }
        ...
        case 3:
          if ((0, _utils.fileExists)(payload.input)) {
            _context.next = 5;
            break;
          }
          throw new Error("Input file doesn't exist");
        case 5:
          if (!(payload.output && !payload.overwrite && (0, _utils.fileExists)(payload.output))) {
            _context.next = 7;
            break;
          }
          throw new Error("Output file already exists");
        case 7:
          callArguments = []; // If the keyLength is 40, `--allow-weak-crypto` needs to be specified before `--encrypt`.
          ...
          if (!(_typeof(payload.password) === "object")) {
            _context.next = 16;
            break;
          }
          if (!(
        ...
        case 17:
          ...
          if (!(_typeof(payload.restrictions) !== "object")) {
            _context.next = 21;
            break;
          }
          throw new Error("Invalid Restrictions");
        case 21:
          for (_i = 0, _Object$entries = Object.entries(payload.restrictions); _i < _Object$entries.length; _i++) {
            _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2), restriction = _Object$entries$_i[0], value = _Object$entries$_i[1];
            // cleartextMetadata does not have a value
            if (restriction === "cleartextMetadata" && value === true) {
              callArguments.push("--".concat((0, _utils.hyphenate)(restriction)));
            }
            if (restriction === "useAes" && payload.keyLength === 256) {
              // use-aes is always on with 256 bit keyLength
            } else {
              callArguments.push("--".concat((0, _utils.hyphenate)(restriction), "=").concat(value));
            }
          }
        case 22:
          ...
          return _context.abrupt("return", (0, _spawn["default"])(callArguments));
        case 25:
        case "end":
